...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Данное значение поля :attribute встречалось в утечке данных. Пожалуйста, выберите другое значение.',
    ],
    ...
    'present_unless' => 'Поле :attribute должно быть представлено, если только :other не равно :value.',
    'present_with' => 'Поле :attribute должно быть представлено, когда :values присутствуют.',
    'present_with_all' => 'Поле :attribute должно быть представлено, когда :values присутствуют.',
    ...
    'required_unless' => 'Поле :attribute обязательно для заполнения, если только :other не в :values.',
